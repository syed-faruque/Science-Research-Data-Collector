...
app.post('/showprev', (req, res) => {
    ...
    connection.query(sqlcommand, [info + " * ", req.session.username], (err, results) => {
        ...
        res.sendFile(__dirname + "/prevlog.html");
    });
});
...
app.get('/getprev', (req, res) =>{
    ...
    connection.query(getInfoQuery, [req.session.username],(err, results) => {
...
app.post('/showlogs', (req, res) =>{
    ...
    connection.query(checker, [user], (err, results)=>{
        if (results.length > 0){
            ...
            res.sendFile(__dirname + "/showdesiredlogs.html");
        }
        else{
            res.sendFile(__dirname + "/noexist.html");
        }
    })
